      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-center gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          ...
          <div>
            ...
            <h2 className=" mb-8 max-md:mb-4">Our business is steered by our core values</h2>
            <p className="mb-11  max-md:mb-6">
              At Fiscalacts, we are committed to providing exceptional tax and accounting solutions with integrity, transparency, and expertise that our clients can trust.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="dark:text-white"> Our Passion </span>
              </li>
              <li className="flex items-center gap-x-2">
              ...
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="dark:text-white"> Our Mission </span>
              </li>
            </ul>
          </div>
        </div>
