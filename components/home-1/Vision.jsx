    ...
    <section className="bg-gray dark:bg-dark relative -mt-24 overflow-hidden pt-[300px] pb-150 max-md:-mt-60 max-md:pt-[320px] max-md:pb-20 dark:-mt-24 dark:max-md:-mt-60">
      ...
      <div className="relative z-10 container">
        <div className="1xl:gap-x-24 grid grid-cols-2 items-end gap-10 max-md:grid-cols-1">
          <div>
            <p className="section-tagline">Expert Services</p>
            <h2 className="mb-8 max-lg:mb-4">Comprehensive tax and accounting solutions for your business growth.</h2>
            <p className="mb-11 max-lg:mb-5">
              Fiscalacts provides end-to-end accounting, taxation, and business consultancy services designed to help your business comply with regulations while optimizing financial performance. Our FTA-approved professionals are committed to your success.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4">
              <li className="flex items-center gap-x-2">
                ...
                <span className="font-jakarta font-medium dark:text-white">Expert-Led Accounting & Compliance Solutions</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center dark:bg-dark-200 relative flex h-7 w-7 justify-center rounded-full bg-white">
                  <FaCheck className="text-paragraph dark:text-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                </span>
                <span className="font-jakarta font-medium dark:text-white">Tech-Driven Financial Management Systems</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className="shadow-icon item-center dark:bg-dark-200 relative flex h-7 w-7 justify-center rounded-full bg-white">
                  <FaCheck className="text-paragraph dark:text-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                ...
                <span className="font-jakarta font-medium dark:text-white">Reliable Support with 100% Client Satisfaction</span>
              </li>
            </ul>
