    ...
    <section className={cn('client', className)}>
      <div className="container overflow-hidden max-lg:!px-0">
        <div className=" px-10px mx-auto max-w-[550px] text-center max-lg:px-2.5">
          {sectionTitle && <h2 className="mb-10">The world&rsquo;s best companies trust Fiscalacts.</h2>}
          {sectionDetails && <p className="text-light mb-15">Trusted by thousands of businesses for expert tax and accounting solutions</p>}
        </div>
